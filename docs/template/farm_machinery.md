...
[embedmd]:# (N:/em/work1/FarmDyn/FarmDyn_QM/gams/model/templ_decl.gms GAMS /(?i)set.*?machtype/ /;/)
```GAMS
...
[embedmd]:# (N:/em/work1/FarmDyn/FarmDyn_QM/gams/coeffgen/tech.gms GAMS /set\soperation/ /;/)
```GAMS
...
table p_plotSizeEffect(crops,machVar,opAttr,plotSize)
 ...
 ;
```
[embedmd]:# (N:/em/work1/FarmDyn/FarmDyn_QM/gams/coeffgen/tech.gms GAMS /p_plotSize.*?"n/ /;/)
```GAMS
p_plotSizeEffect("winterWheat",machVar,"nPers",plotSize) = 1;
```
[embedmd]:# (N:/em/work1/FarmDyn/FarmDyn_QM/gams/coeffgen/tech.gms GAMS /p_plotSize.*?"am/ /;/)
```GAMS
p_plotSizeEffect("winterWheat",machVar,"amount",plotSize) = 1;
```

[embedmd]:# (N:/em/work1/FarmDyn/FarmDyn_QM/gams/coeffgen/tech.gms GAMS /p_plotSize.*?\$/ /;/)
```GAMS
...
[embedmd]:# (N:/em/work1/FarmDyn/FarmDyn_QM/gams/coeffgen/tech.gms GAMS /(?i)table\scrop_op_per_till/ /0.333/)
```GAMS
...
[embedmd]:# (N:/em/work1/FarmDyn/FarmDyn_QM/gams/model/templ.gms GAMS /machInv_\(cur/ /;/)
```GAMS
...
```
[embedmd]:# (N:/em/work1/FarmDyn/FarmDyn_QM/gams/model/templ.gms GAMS /machines_\(c/ /;/)
```GAMS
...
[embedmd]:# (N:/em/work1/FarmDyn/FarmDyn_QM/gams/model/templ.gms GAMS /machInvT_\(c/ /;/)
```GAMS

...
\author[1]{Wolfgang Britz}
\author[1]{Bernd Lengers}
\author[1]{Till Kuhn}
\author[1]{David Schäfer}
\author[1]{Christoph Pahmeyer}
\author[1]{Lennart Kokemohr}
\author[1]{Julia Heinrichs}
\affil[1]{Modeling of Agricultural Systems Group, ILR, University Bonn}
